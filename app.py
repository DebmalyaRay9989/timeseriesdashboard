...
# choix fenetre
fenetre = st.sidebar.slider('Enter a window (days)', min_value=2,max_value=268, value=50)
st.subheader('For '+slider_1+', '+slider_2+', '+slider_3+', '+slider_4+' (window of '+str(fenetre)+' days)\n')
st.write("##")
###############################################################
